...
:: ─── STEP 3: Stop development containers to free port 5005 ──────────────────
echo.
echo [3/6] Stopping development containers (if running) to free port 5005...
cd /d "%installDir%"
...
echo.
echo [6/6] Building and starting containers (5-15 minutes on first run)...
cd /d "%installDir%"
